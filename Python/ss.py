...
# 1.唐僧
# 2.白骨精""")
# user = int(float(input("请输入您的选择(数字)：")))
# while user == 1:
#     print(f"""恭喜您。您选择的角色是唐僧 攻击力：{ji} 生命值：{xue}""")
#     print(xzs)
#     print("提示：选择除1、2、3以外的数字游戏会重新开始！！！")
#     xz1 = int(input("请输入您的选择(数字)："))
#     while xz1 == 1:
#         ji += 2
#         xue += 2
#         lj =f"唐僧 攻击力提升为：{ji} 生命值：{xue}"
#         print(lj)
#         xz1 = int(float(input("请输入您的选择(数字)：")))
#     while xz1 == 2:
#         xue -= bgji
#         bgx -= ji
#         if xue <= 0:
...
#             input("按回车键重新开始游戏")
#             break
#         elif xue >0 and bgx > 0:
#             print(f"""你对白骨精造成了{ji}点伤害
#             白骨精剩余{bgx - ji}滴血
#             你受到了白骨精{bgji}点伤害
#             你剩余{xue - bgji}点血""")
#             print(xzs)
...
#         break
# while user == 2 :
#     print(f"你竟然选择白骨精！！ 太不要脸了，系统已自动为您转换为唐僧 攻击力：{ji} 生命值：{xue}")
#     print(xzs)
#     print("提示：选择除1、2、3以外的数字游戏会重新开始！！！")
#     xz1 = int(float(input("请输入您的选择(数字)：")))
#     while xz1 == 1:
